// Runtime registry and local detection. Concrete implementations live in claudeRuntime.ts / codexRuntime.ts.
...
const REG: Record<string, Runtime> = { claude: claudeRuntime, codex: codexRuntime };
